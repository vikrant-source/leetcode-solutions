...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color/)
...
**My Solution:** [2038-Remove-Colored-Pieces-if-Both-Neighbors-are-the-Same-Color.java](./2038-Remove-Colored-Pieces-if-Both-Neighbors-are-the-Same-Color.java)
